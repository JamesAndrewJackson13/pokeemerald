...
extern const u8 gText_Birch_AboutTown[];
extern const u8 gText_Birch_MyKidName[];
extern const u8 gText_Birch_ConfirmMyKidName[];
extern const u8 gText_Birch_TheyreRival[];
