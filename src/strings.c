...
const u8 gText_OptionMenuCancel[] = _("Exit");
...
const u8 gText_SideQuestName_15[] = _("{SIZE 0}Do machines dream of shiny Mareep?{RESET_SIZE}");
...
const u8 gText_SideQuestDesc_15[] = _(
    "Computers at the Space Center\n"
    "are acting strangely. \n"
    "Find Pokémon to help!"
);
...
const u8 gText_SideQuestPOC_15[] = _("{SIZE 0}Space Center Scientist Floor 2{RESET_SIZE}");
...
const u8 gText_SideQuestMap_15[] = _("Mossdeep City Space Center");
...
const u8 gText_SideQuestReward_15[] = _("A rare Pokémon");
