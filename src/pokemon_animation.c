...
static void Anim_VibrateToCorners(struct Sprite* sprite); // pokemonanimfunc_39
...
static void Anim_HorizontalRepeatedSpring(struct Sprite* sprite);  // pokemonanimfunc_70
...
static void Anim_ShakeGlowBlack_Fast(struct Sprite* sprite);
static void Anim_ShakeGlowBlack(struct Sprite *sprite);
static void Anim_ShakeGlowBlack_Slow(struct Sprite *sprite);
static void Anim_ShakeGlowWhite_Fast(struct Sprite* sprite);
static void Anim_ShakeGlowWhite(struct Sprite *sprite);
...
static void (* const sMonAnimFunctions[])(struct Sprite *sprite) =
{
    ...
    [ANIM_SHAKE_GLOW_BLACK_FAST]             = Anim_ShakeGlowRed_Fast,
    [ANIM_SHAKE_GLOW_BLACK]                  = Anim_ShakeGlowRed,
    [ANIM_SHAKE_GLOW_BLACK_SLOW]             = Anim_ShakeGlowRed_Slow,
    [ANIM_SHAKE_GLOW_WHITE_FAST]             = Anim_ShakeGlowGreen_Fast,
    [ANIM_SHAKE_GLOW_WHITE]                  = Anim_ShakeGlowGreen,
    [ANIM_SHAKE_GLOW_WHITE_SLOW]             = Anim_ShakeGlowGreen_Slow,
    [ANIM_SHAKE_GLOW_PURPLE_FAST]            = Anim_ShakeGlowBlue_Fast,
    [ANIM_SHAKE_GLOW_PURPLE]                 = Anim_ShakeGlowBlue,
    [ANIM_SHAKE_GLOW_PURPLE_SLOW]            = Anim_ShakeGlowBlue_Slow,
};
...
#define ANIM_SHAKEGLOW_SPEED_SLOW 80
#define ANIM_SHAKEGLOW_SPEED_MID  20
#define ANIM_SHAKEGLOW_SPEED_FAST 10

#define Anim_ShakeGlow(shakeglowColor, rateOfSpeed)                         \
{                                                                           \
    if (sprite->data[2] == 0)                                               \
    {                                                                       \
        sprite->data[7] = (sprite->oam.paletteNum * 16) + 256;              \
        sprite->data[0] = rateOfSpeed;                                      \
        sprite->data[5] = 0;                                                \
        sprite->data[4] = 2;                                                \
        sprite->data[3] = 0;                                                \
        sprite->data[1] = shakeglowColor;                                   \
    }                                                                       \
                                                                            \
    if (sprite->data[2] % 2 == 0)                                           \
...
static void Anim_ShakeGlowRed_Fast(struct Sprite *sprite)
{
    Anim_ShakeGlow(SHAKEGLOW_RED, ANIM_SHAKEGLOW_SPEED_FAST)
}

static void Anim_ShakeGlowRed(struct Sprite *sprite)
{
    Anim_ShakeGlow(SHAKEGLOW_RED, ANIM_SHAKEGLOW_SPEED_MID)
}
...
static void Anim_ShakeGlowGreen_Fast(struct Sprite *sprite)
{
    Anim_ShakeGlow(SHAKEGLOW_GREEN, ANIM_SHAKEGLOW_SPEED_FAST)
}

static void Anim_ShakeGlowGreen(struct Sprite *sprite)
{
    Anim_ShakeGlow(SHAKEGLOW_GREEN, ANIM_SHAKEGLOW_SPEED_MID)
}

static void Anim_ShakeGlowGreen_Slow(struct Sprite *sprite)
{
    Anim_ShakeGlow(SHAKEGLOW_GREEN, ANIM_SHAKEGLOW_SPEED_SLOW)
}

static void Anim_ShakeGlowBlue_Fast(struct Sprite *sprite)
{
    Anim_ShakeGlow(SHAKEGLOW_BLUE, ANIM_SHAKEGLOW_SPEED_FAST)
}

static void Anim_ShakeGlowBlue(struct Sprite *sprite)
{
    Anim_ShakeGlow(SHAKEGLOW_BLUE, ANIM_SHAKEGLOW_SPEED_MID)
}

static void Anim_ShakeGlowBlue_Slow(struct Sprite *sprite)
{
    Anim_ShakeGlow(SHAKEGLOW_BLUE, ANIM_SHAKEGLOW_SPEED_SLOW)
}

static void Anim_ShakeGlowBlack_Fast(struct Sprite *sprite)
{
    Anim_ShakeGlow(SHAKEGLOW_BLACK, ANIM_SHAKEGLOW_SPEED_FAST)
}

static void Anim_ShakeGlowBlack(struct Sprite *sprite)
{
    Anim_ShakeGlow(SHAKEGLOW_BLACK, ANIM_SHAKEGLOW_SPEED_MID)
}

static void Anim_ShakeGlowBlack_Slow(struct Sprite *sprite)
{
    Anim_ShakeGlow(SHAKEGLOW_BLACK, ANIM_SHAKEGLOW_SPEED_SLOW)
}

static void Anim_ShakeGlowWhite_Fast(struct Sprite *sprite)
{
    Anim_ShakeGlow(SHAKEGLOW_WHITE, ANIM_SHAKEGLOW_SPEED_FAST)
}

static void Anim_ShakeGlowWhite(struct Sprite *sprite)
{
    Anim_ShakeGlow(SHAKEGLOW_WHITE, ANIM_SHAKEGLOW_SPEED_MID)
}

static void Anim_ShakeGlowWhite_Slow(struct Sprite *sprite)
{
    Anim_ShakeGlow(SHAKEGLOW_WHITE, ANIM_SHAKEGLOW_SPEED_SLOW)
}

static void Anim_ShakeGlowPurple_Fast(struct Sprite *sprite)
{
    Anim_ShakeGlow(SHAKEGLOW_PURPLE, ANIM_SHAKEGLOW_SPEED_FAST)
}

static void Anim_ShakeGlowPurple(struct Sprite *sprite)
{
    Anim_ShakeGlow(SHAKEGLOW_PURPLE, ANIM_SHAKEGLOW_SPEED_MID)
}

static void Anim_ShakeGlowPurple_Slow(struct Sprite *sprite)
{
    Anim_ShakeGlow(SHAKEGLOW_PURPLE, ANIM_SHAKEGLOW_SPEED_SLOW)
}
