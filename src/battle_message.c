...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
    {
        ...
        [STRINGID_CANACTFASTERTHANKSTO- BATTLESTRINGS_ID_ADDER] = sText_CanActFaster,
        [STRINGID_CURIOUSMEDICINEENTERS- BATTLESTRINGS_ID_ADDER] = sText_CuriousMedicineEnters,
        [STRINGID_ASONEENTERS- BATTLESTRINGS_ID_ADDER] = sText_AsOneEnters,
        [STRINGID_ABILITYRAISEDSTATDRASTICALLY- BATTLESTRINGS_ID_ADDER] = sText_AbilityRaisedStatDrastically,
        [STRINGID_PKMNSWILLPERISHIN3TURNS- BATTLESTRINGS_ID_ADDER] = sText_PkmnsWillPerishIn3Turns,
        [STRINGID_ASANDSTORMKICKEDUP- BATTLESTRINGS_ID_ADDER] = sText_ASandstormKickedUp,
        [STRINGID_BATTLERABILITYRAISEDSTAT- BATTLESTRINGS_ID_ADDER] = sText_BattlerAbilityRaisedStat,
        [STRINGID_FETCHEDPOKEBALL- BATTLESTRINGS_ID_ADDER] = sText_FetchedPokeBall,
        [STRINGID_STATWASNOTLOWERED- BATTLESTRINGS_ID_ADDER] = sText_StatWasNotLowered,
        [STRINGID_CLOAKEDINAFREEZINGLIGHT- BATTLESTRINGS_ID_ADDER] = sText_CloakedInAFreezingLight,
        [STRINGID_DESTINYKNOTACTIVATES- BATTLESTRINGS_ID_ADDER] = sText_DestinyKnotActivates,
        [STRINGID_NOONEWILLBEABLETORUNAWAY- BATTLESTRINGS_ID_ADDER] = sText_NoOneWillBeAbleToRun,
        [STRINGID_PKNMABSORBINGPOWER- BATTLESTRINGS_ID_ADDER] = sText_PkmnAbsorbingPower,
        [STRINGID_RECEIVERABILITYTAKEOVER- BATTLESTRINGS_ID_ADDER] = sText_ReceiverAbilityTakeOver,
        [STRINGID_SCRIPTINGABILITYSTATRAISE- BATTLESTRINGS_ID_ADDER] = sText_ScriptingAbilityRaisedStat,
        [STRINGID_HEALERCURE- BATTLESTRINGS_ID_ADDER] = sText_HealerCure,
        [STRINGID_ATTACKERLOSTFIRETYPE- BATTLESTRINGS_ID_ADDER] = sText_AttackerLostFireType,
        [STRINGID_ATTACKERCUREDTARGETSTATUS- BATTLESTRINGS_ID_ADDER] = sText_AttackerCuredTargetStatus,
        [STRINGID_ILLUSIONWOREOFF- BATTLESTRINGS_ID_ADDER] = sText_IllusionWoreOff,
        [STRINGID_BUGBITE- BATTLESTRINGS_ID_ADDER] = sText_BugBite,
        [STRINGID_INCINERATEBURN- BATTLESTRINGS_ID_ADDER] = sText_IncinerateBurn,
        [STRINGID_AIRBALLOONPOP- BATTLESTRINGS_ID_ADDER] = sText_AirBalloonPop,
        [STRINGID_AIRBALLOONFLOAT- BATTLESTRINGS_ID_ADDER] = sText_AirBalloonFloat,
        [STRINGID_TARGETATEITEM- BATTLESTRINGS_ID_ADDER] = sText_TargetAteItem,
        [STRINGID_BERRYDMGREDUCES- BATTLESTRINGS_ID_ADDER] = sText_BerryDmgReducing,
        [STRINGID_GEMACTIVATES- BATTLESTRINGS_ID_ADDER] = sText_GemActivates,
        [STRINGID_LASERFOCUS- BATTLESTRINGS_ID_ADDER] = sText_LaserFocusMessage,
        [STRINGID_THROATCHOPENDS- BATTLESTRINGS_ID_ADDER] = sText_ThroatChopEnds,
        [STRINGID_PKMNCANTUSEMOVETHROATCHOP- BATTLESTRINGS_ID_ADDER] = sText_PkmnCantUseMoveThroatChop,
        [STRINGID_USEDINSTRUCTEDMOVE- BATTLESTRINGS_ID_ADDER] = sText_UsedInstructedMove,
        [STRINGID_CELEBRATEMESSAGE- BATTLESTRINGS_ID_ADDER] = sText_CelebrateMessage,
        ...
        [STRINGID_SAFETYGOOGLESPROTECTED- BATTLESTRINGS_ID_ADDER] = sText_SafetyGooglesProtected,
        [STRINGID_SPECTRALTHIEFSTEAL- BATTLESTRINGS_ID_ADDER] = sText_SpectralThiefSteal,
        [STRINGID_BELCHCANTSELECT- BATTLESTRINGS_ID_ADDER] = sText_BelchCantUse,
        ...
        [STRINGID_PKMNLEARNEDMOVE2- BATTLESTRINGS_ID_ADDER] = sText_PkmnLearnedMove2,
        [STRINGID_ATTACKMISSED- BATTLESTRINGS_ID_ADDER] = sText_AttackMissed,
        [STRINGID_PKMNPROTECTEDITSELF- BATTLESTRINGS_ID_ADDER] = sText_PkmnProtectedItself,
        [STRINGID_STATSWONTINCREASE2- BATTLESTRINGS_ID_ADDER] = sText_StatsWontIncrease2,
        [STRINGID_AVOIDEDDAMAGE- BATTLESTRINGS_ID_ADDER] = sText_AvoidedDamage,
        [STRINGID_ITDOESNTAFFECT- BATTLESTRINGS_ID_ADDER] = sText_ItDoesntAffect,
        [STRINGID_ATTACKERFAINTED- BATTLESTRINGS_ID_ADDER] = sText_AttackerFainted,
        [STRINGID_TARGETFAINTED- BATTLESTRINGS_ID_ADDER] = sText_TargetFainted,
        [STRINGID_PLAYERGOTMONEY- BATTLESTRINGS_ID_ADDER] = sText_PlayerGotMoney,
        #ifdef 
        [STRINGID_PLAYERLOSTAGAINSTENEMYTRAINER- BATTLESTRINGS_ID_ADDER] = sText_PlayerLostAgainstEnemyTrainer,
        [STRINGID_PLAYERPAIDPRIZEMONEY- BATTLESTRINGS_ID_ADDER] = sText_PlayerPaidPrizeMoney,
        [STRINGID_PLAYERWHITEOUT- BATTLESTRINGS_ID_ADDER] = sText_PlayerWhiteout,
        [STRINGID_PLAYERWHITEOUT2- BATTLESTRINGS_ID_ADDER] = sText_PlayerWhiteout2,
        [STRINGID_PREVENTSESCAPE- BATTLESTRINGS_ID_ADDER] = sText_PreventsEscape,
        [STRINGID_HITXTIMES- BATTLESTRINGS_ID_ADDER] = sText_HitXTimes,
        [STRINGID_PKMNFELLASLEEP- BATTLESTRINGS_ID_ADDER] = sText_PkmnFellAsleep,
        [STRINGID_PKMNMADESLEEP- BATTLESTRINGS_ID_ADDER] = sText_PkmnMadeSleep,
        [STRINGID_PKMNALREADYASLEEP- BATTLESTRINGS_ID_ADDER] = sText_PkmnAlreadyAsleep,
        [STRINGID_PKMNALREADYASLEEP2- BATTLESTRINGS_ID_ADDER] = sText_PkmnAlreadyAsleep2,
        [STRINGID_PKMNWASNTAFFECTED- BATTLESTRINGS_ID_ADDER] = sText_PkmnWasntAffected,
        [STRINGID_PKMNWASPOISONED- BATTLESTRINGS_ID_ADDER] = sText_PkmnWasPoisoned,
        [STRINGID_PKMNPOISONEDBY- BATTLESTRINGS_ID_ADDER] = sText_PkmnPoisonedBy,
        [STRINGID_PKMNHURTBYPOISON- BATTLESTRINGS_ID_ADDER] = sText_PkmnHurtByPoison,
        [STRINGID_PKMNALREADYPOISONED- BATTLESTRINGS_ID_ADDER] = sText_PkmnAlreadyPoisoned,
        [STRINGID_PKMNBADLYPOISONED- BATTLESTRINGS_ID_ADDER] = sText_PkmnBadlyPoisoned,
        [STRINGID_PKMNENERGYDRAINED- BATTLESTRINGS_ID_ADDER] = sText_PkmnEnergyDrained,
        [STRINGID_PKMNWASBURNED- BATTLESTRINGS_ID_ADDER] = sText_PkmnWasBurned,
        [STRINGID_PKMNBURNEDBY- BATTLESTRINGS_ID_ADDER] = sText_PkmnBurnedBy,
        [STRINGID_PKMNHURTBYBURN- BATTLESTRINGS_ID_ADDER] = sText_PkmnHurtByBurn,
        [STRINGID_PKMNWASFROZEN- BATTLESTRINGS_ID_ADDER] = sText_PkmnWasFrozen,
        [STRINGID_PKMNFROZENBY- BATTLESTRINGS_ID_ADDER] = sText_PkmnFrozenBy,
        [STRINGID_PKMNISFROZEN- BATTLESTRINGS_ID_ADDER] = sText_PkmnIsFrozen,
        [STRINGID_PKMNWASDEFROSTED- BATTLESTRINGS_ID_ADDER] = sText_PkmnWasDefrosted,
        [STRINGID_PKMNWASDEFROSTED2- BATTLESTRINGS_ID_ADDER] = sText_PkmnWasDefrosted2,
        [STRINGID_PKMNWASDEFROSTEDBY- BATTLESTRINGS_ID_ADDER] = sText_PkmnWasDefrostedBy,
        [STRINGID_PKMNWASPARALYZED- BATTLESTRINGS_ID_ADDER] = sText_PkmnWasParalyzed,
        [STRINGID_PKMNWASPARALYZEDBY- BATTLESTRINGS_ID_ADDER] = sText_PkmnWasParalyzedBy,
        [STRINGID_PKMNISPARALYZED- BATTLESTRINGS_ID_ADDER] = sText_PkmnIsParalyzed,
        [STRINGID_PKMNISALREADYPARALYZED- BATTLESTRINGS_ID_ADDER] = sText_PkmnIsAlreadyParalyzed,
        [STRINGID_PKMNHEALEDPARALYSIS- BATTLESTRINGS_ID_ADDER] = sText_PkmnHealedParalysis,
        [STRINGID_PKMNDREAMEATEN- BATTLESTRINGS_ID_ADDER] = sText_PkmnDreamEaten,
        ...
        [STRINGID_TEAMSTOPPEDWORKING- BATTLESTRINGS_ID_ADDER] = sText_TeamStoppedWorking,
        [STRINGID_FOESTOPPEDWORKING- BATTLESTRINGS_ID_ADDER] = sText_FoeStoppedWorking,
        [STRINGID_PKMNISCONFUSED- BATTLESTRINGS_ID_ADDER] = sText_PkmnIsConfused,
        [STRINGID_PKMNHEALEDCONFUSION- BATTLESTRINGS_ID_ADDER] = sText_PkmnHealedConfusion,
        [STRINGID_PKMNWASCONFUSED- BATTLESTRINGS_ID_ADDER] = sText_PkmnWasConfused,
        [STRINGID_PKMNALREADYCONFUSED- BATTLESTRINGS_ID_ADDER] = sText_PkmnAlreadyConfused,
        [STRINGID_PKMNFELLINLOVE- BATTLESTRINGS_ID_ADDER] = sText_PkmnFellInLove,
        [STRINGID_PKMNINLOVE- BATTLESTRINGS_ID_ADDER] = sText_PkmnInLove,
        [STRINGID_PKMNIMMOBILIZEDBYLOVE- BATTLESTRINGS_ID_ADDER] = sText_PkmnImmobilizedByLove,
        [STRINGID_PKMNBLOWNAWAY- BATTLESTRINGS_ID_ADDER] = sText_PkmnBlownAway,
        [STRINGID_PKMNCHANGEDTYPE- BATTLESTRINGS_ID_ADDER] = sText_PkmnChangedType,
        [STRINGID_PKMNFLINCHED- BATTLESTRINGS_ID_ADDER] = sText_PkmnFlinched,
        [STRINGID_PKMNREGAINEDHEALTH- BATTLESTRINGS_ID_ADDER] = sText_PkmnRegainedHealth,
        [STRINGID_PKMNHPFULL- BATTLESTRINGS_ID_ADDER] = sText_PkmnHPFull,
        [STRINGID_PKMNRAISEDSPDEF- BATTLESTRINGS_ID_ADDER] = sText_PkmnRaisedSpDef,
        [STRINGID_PKMNRAISEDDEF- BATTLESTRINGS_ID_ADDER] = sText_PkmnRaisedDef,
        [STRINGID_PKMNCOVEREDBYVEIL- BATTLESTRINGS_ID_ADDER] = sText_PkmnCoveredByVeil,
        [STRINGID_PKMNUSEDSAFEGUARD- BATTLESTRINGS_ID_ADDER] = sText_PkmnUsedSafeguard,
        [STRINGID_PKMNSAFEGUARDEXPIRED- BATTLESTRINGS_ID_ADDER] = sText_PkmnSafeguardExpired,
        [STRINGID_PKMNWENTTOSLEEP- BATTLESTRINGS_ID_ADDER] = sText_PkmnWentToSleep,
        [STRINGID_PKMNSLEPTHEALTHY- BATTLESTRINGS_ID_ADDER] = sText_PkmnSleptHealthy,
        [STRINGID_PKMNWHIPPEDWHIRLWIND- BATTLESTRINGS_ID_ADDER] = sText_PkmnWhippedWhirlwind,
        [STRINGID_PKMNTOOKSUNLIGHT- BATTLESTRINGS_ID_ADDER] = sText_PkmnTookSunlight,
        [STRINGID_PKMNLOWEREDHEAD- BATTLESTRINGS_ID_ADDER] = sText_PkmnLoweredHead,
        [STRINGID_PKMNISGLOWING- BATTLESTRINGS_ID_ADDER] = sText_PkmnIsGlowing,
        [STRINGID_PKMNFLEWHIGH- BATTLESTRINGS_ID_ADDER] = sText_PkmnFlewHigh,
        [STRINGID_PKMNDUGHOLE- BATTLESTRINGS_ID_ADDER] = sText_PkmnDugHole,
        [STRINGID_PKMNSQUEEZEDBYBIND- BATTLESTRINGS_ID_ADDER] = sText_PkmnSqueezedByBind,
        [STRINGID_PKMNTRAPPEDINVORTEX- BATTLESTRINGS_ID_ADDER] = sText_PkmnTrappedInVortex,
        [STRINGID_PKMNWRAPPEDBY- BATTLESTRINGS_ID_ADDER] = sText_PkmnWrappedBy,
        [STRINGID_PKMNCLAMPED- BATTLESTRINGS_ID_ADDER] = sText_PkmnClamped,
        [STRINGID_PKMNHURTBY- BATTLESTRINGS_ID_ADDER] = sText_PkmnHurtBy,
        [STRINGID_PKMNFREEDFROM- BATTLESTRINGS_ID_ADDER] = sText_PkmnFreedFrom,
        [STRINGID_PKMNCRASHED- BATTLESTRINGS_ID_ADDER] = sText_PkmnCrashed,
        [STRINGID_PKMNSHROUDEDINMIST- BATTLESTRINGS_ID_ADDER] = gText_PkmnShroudedInMist,
        [STRINGID_PKMNPROTECTEDBYMIST- BATTLESTRINGS_ID_ADDER] = sText_PkmnProtectedByMist,
        [STRINGID_PKMNGETTINGPUMPED- BATTLESTRINGS_ID_ADDER] = gText_PkmnGettingPumped,
        [STRINGID_PKMNHITWITHRECOIL- BATTLESTRINGS_ID_ADDER] = sText_PkmnHitWithRecoil,
        [STRINGID_PKMNPROTECTEDITSELF2- BATTLESTRINGS_ID_ADDER] = sText_PkmnProtectedItself2,
        [STRINGID_PKMNBUFFETEDBYSANDSTORM- BATTLESTRINGS_ID_ADDER] = sText_PkmnBuffetedBySandstorm,
        [STRINGID_PKMNPELTEDBYHAIL- BATTLESTRINGS_ID_ADDER] = sText_PkmnPeltedByHail,
        [STRINGID_PKMNSEEDED- BATTLESTRINGS_ID_ADDER] = sText_PkmnSeeded,
        [STRINGID_PKMNEVADEDATTACK- BATTLESTRINGS_ID_ADDER] = sText_PkmnEvadedAttack,
        [STRINGID_PKMNSAPPEDBYLEECHSEED- BATTLESTRINGS_ID_ADDER] = sText_PkmnSappedByLeechSeed,
        [STRINGID_PKMNFASTASLEEP- BATTLESTRINGS_ID_ADDER] = sText_PkmnFastAsleep,
        [STRINGID_PKMNWOKEUP- BATTLESTRINGS_ID_ADDER] = sText_PkmnWokeUp,
        [STRINGID_PKMNUPROARKEPTAWAKE- BATTLESTRINGS_ID_ADDER] = sText_PkmnUproarKeptAwake,
        [STRINGID_PKMNWOKEUPINUPROAR- BATTLESTRINGS_ID_ADDER] = sText_PkmnWokeUpInUproar,
        ...
        [STRINGID_PKMNSTORINGENERGY- BATTLESTRINGS_ID_ADDER] = sText_PkmnStoringEnergy,
        [STRINGID_PKMNUNLEASHEDENERGY- BATTLESTRINGS_ID_ADDER] = sText_PkmnUnleashedEnergy,
        [STRINGID_PKMNFATIGUECONFUSION- BATTLESTRINGS_ID_ADDER] = sText_PkmnFatigueConfusion,
        [STRINGID_PLAYERPICKEDUPMONEY- BATTLESTRINGS_ID_ADDER] = sText_PlayerPickedUpMoney,
        [STRINGID_PKMNUNAFFECTED- BATTLESTRINGS_ID_ADDER] = sText_PkmnUnaffected,
        [STRINGID_PKMNTRANSFORMEDINTO- BATTLESTRINGS_ID_ADDER] = sText_PkmnTransformedInto,
        [STRINGID_PKMNMADESUBSTITUTE- BATTLESTRINGS_ID_ADDER] = sText_PkmnMadeSubstitute,
        [STRINGID_PKMNHASSUBSTITUTE- BATTLESTRINGS_ID_ADDER] = sText_PkmnHasSubstitute,
        [STRINGID_SUBSTITUTEDAMAGED- BATTLESTRINGS_ID_ADDER] = sText_SubstituteDamaged,
        [STRINGID_PKMNSUBSTITUTEFADED- BATTLESTRINGS_ID_ADDER] = sText_PkmnSubstituteFaded,
        [STRINGID_PKMNMUSTRECHARGE- BATTLESTRINGS_ID_ADDER] = sText_PkmnMustRecharge,
        [STRINGID_PKMNRAGEBUILDING- BATTLESTRINGS_ID_ADDER] = sText_PkmnRageBuilding,
        [STRINGID_PKMNMOVEWASDISABLED- BATTLESTRINGS_ID_ADDER] = sText_PkmnMoveWasDisabled,
        [STRINGID_PKMNMOVEISDISABLED- BATTLESTRINGS_ID_ADDER] = sText_PkmnMoveIsDisabled,
        [STRINGID_PKMNMOVEDISABLEDNOMORE- BATTLESTRINGS_ID_ADDER] = sText_PkmnMoveDisabledNoMore,
        [STRINGID_PKMNGOTENCORE- BATTLESTRINGS_ID_ADDER] = sText_PkmnGotEncore,
        [STRINGID_PKMNENCOREENDED- BATTLESTRINGS_ID_ADDER] = sText_PkmnEncoreEnded,
        [STRINGID_PKMNTOOKAIM- BATTLESTRINGS_ID_ADDER] = sText_PkmnTookAim,
        [STRINGID_PKMNSKETCHEDMOVE- BATTLESTRINGS_ID_ADDER] = sText_PkmnSketchedMove,
        [STRINGID_PKMNTRYINGTOTAKEFOE- BATTLESTRINGS_ID_ADDER] = sText_PkmnTryingToTakeFoe,
        [STRINGID_PKMNTOOKFOE- BATTLESTRINGS_ID_ADDER] = sText_PkmnTookFoe,
        [STRINGID_PKMNREDUCEDPP- BATTLESTRINGS_ID_ADDER] = sText_PkmnReducedPP,
        [STRINGID_PKMNSTOLEITEM- BATTLESTRINGS_ID_ADDER] = sText_PkmnStoleItem,
        [STRINGID_TARGETCANTESCAPENOW- BATTLESTRINGS_ID_ADDER] = sText_TargetCantEscapeNow,
        [STRINGID_PKMNFELLINTONIGHTMARE- BATTLESTRINGS_ID_ADDER] = sText_PkmnFellIntoNightmare,
        [STRINGID_PKMNLOCKEDINNIGHTMARE- BATTLESTRINGS_ID_ADDER] = sText_PkmnLockedInNightmare,
        ...
        [STRINGID_PKMNIDENTIFIED- BATTLESTRINGS_ID_ADDER] = sText_PkmnIdentified,
        [STRINGID_PKMNPERISHCOUNTFELL- BATTLESTRINGS_ID_ADDER] = sText_PkmnPerishCountFell,
        [STRINGID_PKMNBRACEDITSELF- BATTLESTRINGS_ID_ADDER] = sText_PkmnBracedItself,
        [STRINGID_PKMNENDUREDHIT- BATTLESTRINGS_ID_ADDER] = sText_PkmnEnduredHit,
        [STRINGID_MAGNITUDESTRENGTH- BATTLESTRINGS_ID_ADDER] = sText_MagnitudeStrength,
        [STRINGID_PKMNCUTHPMAXEDATTACK- BATTLESTRINGS_ID_ADDER] = sText_PkmnCutHPMaxedAttack,
        [STRINGID_PKMNCOPIEDSTATCHANGES- BATTLESTRINGS_ID_ADDER] = sText_PkmnCopiedStatChanges,
        ...
        [STRINGID_PKMNFLEDFROMBATTLE- BATTLESTRINGS_ID_ADDER] = sText_PkmnFledFromBattle,
        [STRINGID_PKMNFORESAWATTACK- BATTLESTRINGS_ID_ADDER] = sText_PkmnForesawAttack,
        [STRINGID_PKMNTOOKATTACK- BATTLESTRINGS_ID_ADDER] = sText_PkmnTookAttack,
        [STRINGID_PKMNATTACK- BATTLESTRINGS_ID_ADDER] = sText_PkmnAttack,
        [STRINGID_PKMNCENTERATTENTION- BATTLESTRINGS_ID_ADDER] = sText_PkmnCenterAttention,
        [STRINGID_PKMNCHARGINGPOWER- BATTLESTRINGS_ID_ADDER] = sText_PkmnChargingPower,
        [STRINGID_NATUREPOWERTURNEDINTO- BATTLESTRINGS_ID_ADDER] = sText_NaturePowerTurnedInto,
        [STRINGID_PKMNSTATUSNORMAL- BATTLESTRINGS_ID_ADDER] = sText_PkmnStatusNormal,
        [STRINGID_PKMNHASNOMOVESLEFT- BATTLESTRINGS_ID_ADDER] = sText_PkmnHasNoMovesLeft,
        [STRINGID_PKMNSUBJECTEDTOTORMENT- BATTLESTRINGS_ID_ADDER] = sText_PkmnSubjectedToTorment,
        [STRINGID_PKMNCANTUSEMOVETORMENT- BATTLESTRINGS_ID_ADDER] = sText_PkmnCantUseMoveTorment,
        [STRINGID_PKMNTIGHTENINGFOCUS- BATTLESTRINGS_ID_ADDER] = sText_PkmnTighteningFocus,
        [STRINGID_PKMNFELLFORTAUNT- BATTLESTRINGS_ID_ADDER] = sText_PkmnFellForTaunt,
        [STRINGID_PKMNCANTUSEMOVETAUNT- BATTLESTRINGS_ID_ADDER] = sText_PkmnCantUseMoveTaunt,
        [STRINGID_PKMNREADYTOHELP- BATTLESTRINGS_ID_ADDER] = sText_PkmnReadyToHelp,
        [STRINGID_PKMNSWITCHEDITEMS- BATTLESTRINGS_ID_ADDER] = sText_PkmnSwitchedItems,
        [STRINGID_PKMNCOPIEDFOE- BATTLESTRINGS_ID_ADDER] = sText_PkmnCopiedFoe,
        [STRINGID_PKMNMADEWISH- BATTLESTRINGS_ID_ADDER] = sText_PkmnMadeWish,
        [STRINGID_PKMNWISHCAMETRUE- BATTLESTRINGS_ID_ADDER] = sText_PkmnWishCameTrue,
        [STRINGID_PKMNPLANTEDROOTS- BATTLESTRINGS_ID_ADDER] = sText_PkmnPlantedRoots,
        [STRINGID_PKMNABSORBEDNUTRIENTS- BATTLESTRINGS_ID_ADDER] = sText_PkmnAbsorbedNutrients,
        [STRINGID_PKMNANCHOREDITSELF- BATTLESTRINGS_ID_ADDER] = sText_PkmnAnchoredItself,
        [STRINGID_PKMNWASMADEDROWSY- BATTLESTRINGS_ID_ADDER] = sText_PkmnWasMadeDrowsy,
        [STRINGID_PKMNKNOCKEDOFF- BATTLESTRINGS_ID_ADDER] = sText_PkmnKnockedOff,
        [STRINGID_PKMNSWAPPEDABILITIES- BATTLESTRINGS_ID_ADDER] = sText_PkmnSwappedAbilities,
        ...
        [STRINGID_PKMNSHROUDEDITSELF- BATTLESTRINGS_ID_ADDER] = sText_PkmnShroudedItself,
        [STRINGID_PKMNMOVEBOUNCED- BATTLESTRINGS_ID_ADDER] = sText_PkmnMoveBounced,
        ...
        [STRINGID_PKMNMADEITRAIN- BATTLESTRINGS_ID_ADDER] = sText_PkmnMadeItRain,
        [STRINGID_PKMNRAISEDSPEED- BATTLESTRINGS_ID_ADDER] = sText_PkmnRaisedSpeed,
        [STRINGID_PKMNPROTECTEDBY- BATTLESTRINGS_ID_ADDER] = sText_PkmnProtectedBy,
        [STRINGID_PKMNPREVENTSUSAGE- BATTLESTRINGS_ID_ADDER] = sText_PkmnPreventsUsage,
        [STRINGID_PKMNRESTOREDHPUSING- BATTLESTRINGS_ID_ADDER] = sText_PkmnRestoredHPUsing,
        [STRINGID_PKMNCHANGEDTYPEWITH- BATTLESTRINGS_ID_ADDER] = sText_PkmnChangedTypeWith,
        ...
        [STRINGID_PKMNPREVENTSPOISONINGWITH- BATTLESTRINGS_ID_ADDER] = sText_PkmnPreventsPoisoningWith,
        [STRINGID_PKMNPREVENTSCONFUSIONWITH- BATTLESTRINGS_ID_ADDER] = sText_PkmnPreventsConfusionWith,
        [STRINGID_PKMNRAISEDFIREPOWERWITH- BATTLESTRINGS_ID_ADDER] = sText_PkmnRaisedFirePowerWith,
        ...
        [STRINGID_PKMNHURTSWITH- BATTLESTRINGS_ID_ADDER] = sText_PkmnHurtsWith,
        [STRINGID_PKMNTRACED- BATTLESTRINGS_ID_ADDER] = sText_PkmnTraced,
        [STRINGID_STATSHARPLY- BATTLESTRINGS_ID_ADDER] = gText_StatSharply,
        [STRINGID_STATROSE- BATTLESTRINGS_ID_ADDER] = gText_StatRose,
        ...
        [STRINGID_WILDPKMNFLED- BATTLESTRINGS_ID_ADDER] = sText_WildPkmnFled,
        ...
        [STRINGID_DONTLEAVEBIRCH- BATTLESTRINGS_ID_ADDER] = sText_DontLeaveBirch,
        ...
        [STRINGID_ITHURTCONFUSION- BATTLESTRINGS_ID_ADDER] = sText_ItHurtConfusion,
        [STRINGID_MIRRORMOVEFAILED- BATTLESTRINGS_ID_ADDER] = sText_MirrorMoveFailed,
        [STRINGID_STARTEDTORAIN- BATTLESTRINGS_ID_ADDER] = sText_StartedToRain,
        [STRINGID_DOWNPOURSTARTED- BATTLESTRINGS_ID_ADDER] = sText_DownpourStarted,
        [STRINGID_RAINCONTINUES- BATTLESTRINGS_ID_ADDER] = sText_RainContinues,
        [STRINGID_DOWNPOURCONTINUES- BATTLESTRINGS_ID_ADDER] = sText_DownpourContinues,
        [STRINGID_RAINSTOPPED- BATTLESTRINGS_ID_ADDER] = sText_RainStopped,
        [STRINGID_SANDSTORMBREWED- BATTLESTRINGS_ID_ADDER] = sText_SandstormBrewed,
        ...
        [STRINGID_SUNLIGHTGOTBRIGHT- BATTLESTRINGS_ID_ADDER] = sText_SunlightGotBright,
        ...
        [STRINGID_WINDBECAMEHEATWAVE- BATTLESTRINGS_ID_ADDER] = sText_WindBecameHeatWave,
        [STRINGID_STATCHANGESGONE- BATTLESTRINGS_ID_ADDER] = sText_StatChangesGone,
        ...
        [STRINGID_SHAREDPAIN- BATTLESTRINGS_ID_ADDER] = sText_SharedPain,
        [STRINGID_BELLCHIMED- BATTLESTRINGS_ID_ADDER] = sText_BellChimed,
        [STRINGID_FAINTINTHREE- BATTLESTRINGS_ID_ADDER] = sText_FaintInThree,
        [STRINGID_NOPPLEFT- BATTLESTRINGS_ID_ADDER] = sText_NoPPLeft,
        [STRINGID_BUTNOPPLEFT- BATTLESTRINGS_ID_ADDER] = sText_ButNoPPLeft,
        [STRINGID_PLAYERUSEDITEM- BATTLESTRINGS_ID_ADDER] = sText_PlayerUsedItem,
        [STRINGID_WALLYUSEDITEM- BATTLESTRINGS_ID_ADDER] = sText_WallyUsedItem,
        ...
        [STRINGID_YOUMISSEDPKMN- BATTLESTRINGS_ID_ADDER] = sText_YouMissedPkmn,
        [STRINGID_PKMNBROKEFREE- BATTLESTRINGS_ID_ADDER] = sText_PkmnBrokeFree,
        [STRINGID_ITAPPEAREDCAUGHT- BATTLESTRINGS_ID_ADDER] = sText_ItAppearedCaught,
        ...
        [STRINGID_GOTCHAPKMNCAUGHT- BATTLESTRINGS_ID_ADDER] = sText_GotchaPkmnCaught,
        [STRINGID_GOTCHAPKMNCAUGHT2- BATTLESTRINGS_ID_ADDER] = sText_GotchaPkmnCaught2,
        [STRINGID_GIVENICKNAMECAPTURED- BATTLESTRINGS_ID_ADDER] = sText_GiveNicknameCaptured,
        [STRINGID_PKMNSENTTOPC- BATTLESTRINGS_ID_ADDER] = sText_PkmnSentToPC,
        [STRINGID_PKMNDATAADDEDTODEX- BATTLESTRINGS_ID_ADDER] = sText_PkmnDataAddedToDex,
        [STRINGID_ITISRAINING- BATTLESTRINGS_ID_ADDER] = sText_ItIsRaining,
        [STRINGID_SANDSTORMISRAGING- BATTLESTRINGS_ID_ADDER] = sText_SandstormIsRaging,
        [STRINGID_CANTESCAPE2- BATTLESTRINGS_ID_ADDER] = sText_CantEscape2,
        [STRINGID_PKMNIGNORESASLEEP- BATTLESTRINGS_ID_ADDER] = sText_PkmnIgnoresAsleep,
        [STRINGID_PKMNIGNOREDORDERS- BATTLESTRINGS_ID_ADDER] = sText_PkmnIgnoredOrders,
        [STRINGID_PKMNBEGANTONAP- BATTLESTRINGS_ID_ADDER] = sText_PkmnBeganToNap,
        [STRINGID_PKMNLOAFING- BATTLESTRINGS_ID_ADDER] = sText_PkmnLoafing,
        [STRINGID_PKMNWONTOBEY- BATTLESTRINGS_ID_ADDER] = sText_PkmnWontObey,
        [STRINGID_PKMNTURNEDAWAY- BATTLESTRINGS_ID_ADDER] = sText_PkmnTurnedAway,
        [STRINGID_PKMNPRETENDNOTNOTICE- BATTLESTRINGS_ID_ADDER] = sText_PkmnPretendNotNotice,
        [STRINGID_ENEMYABOUTTOSWITCHPKMN- BATTLESTRINGS_ID_ADDER] = sText_EnemyAboutToSwitchPkmn,
        [STRINGID_CREPTCLOSER- BATTLESTRINGS_ID_ADDER] = sText_CreptCloser,
        [STRINGID_CANTGETCLOSER- BATTLESTRINGS_ID_ADDER] = sText_CantGetCloser,
        [STRINGID_PKMNWATCHINGCAREFULLY- BATTLESTRINGS_ID_ADDER] = sText_PkmnWatchingCarefully,
        [STRINGID_PKMNCURIOUSABOUTX- BATTLESTRINGS_ID_ADDER] = sText_PkmnCuriousAboutX,
        [STRINGID_PKMNENTHRALLEDBYX- BATTLESTRINGS_ID_ADDER] = sText_PkmnEnthralledByX,
        [STRINGID_PKMNIGNOREDX- BATTLESTRINGS_ID_ADDER] = sText_PkmnIgnoredX,
        [STRINGID_THREWPOKEBLOCKATPKMN- BATTLESTRINGS_ID_ADDER] = sText_ThrewPokeblockAtPkmn,
        ...
        [STRINGID_ITEMALLOWSONLYYMOVE- BATTLESTRINGS_ID_ADDER] = sText_ItemAllowsOnlyYMove,
        [STRINGID_PKMNHUNGONWITHX- BATTLESTRINGS_ID_ADDER] = sText_PkmnHungOnWithX,
        [STRINGID_EMPTYSTRING3- BATTLESTRINGS_ID_ADDER] = gText_EmptyString3,
        [STRINGID_PKMNSXPREVENTSBURNS- BATTLESTRINGS_ID_ADDER] = sText_PkmnsXPreventsBurns,
        ...
        [STRINGID_PKMNHIDUNDERWATER- BATTLESTRINGS_ID_ADDER] = sText_PkmnHidUnderwater,
        [STRINGID_PKMNSPRANGUP- BATTLESTRINGS_ID_ADDER] = sText_PkmnSprangUp,
        ...
        [STRINGID_PKMNTRAPPEDBYSANDTOMB- BATTLESTRINGS_ID_ADDER] = sText_PkmnTrappedBySandTomb,
        [STRINGID_EMPTYSTRING4- BATTLESTRINGS_ID_ADDER] = sText_EmptyString4,
        ...
        [STRINGID_PKMNCHOSEXASDESTINY- BATTLESTRINGS_ID_ADDER] = sText_PkmnChoseXAsDestiny,
        ...
        [STRINGID_TRAINER1USEDITEM- BATTLESTRINGS_ID_ADDER] = sText_Trainer1UsedItem,
        ...
        [STRINGID_PKMNSXWOREOFF- BATTLESTRINGS_ID_ADDER] = sText_PkmnsXWoreOff,
        [STRINGID_PKMNRAISEDDEFALITTLE- BATTLESTRINGS_ID_ADDER] = sText_PkmnRaisedDefALittle,
        [STRINGID_PKMNRAISEDSPDEFALITTLE- BATTLESTRINGS_ID_ADDER] = sText_PkmnRaisedSpDefALittle,
        ...
        [STRINGID_ATTACKERCANTESCAPE- BATTLESTRINGS_ID_ADDER] = sText_AttackerCantEscape,
        ...
        [STRINGID_TWOENEMIESDEFEATED- BATTLESTRINGS_ID_ADDER] = sText_TwoInGameTrainersDefeated,
        [STRINGID_TRAINER2LOSETEXT- BATTLESTRINGS_ID_ADDER] = sText_Trainer2LoseText,
        [STRINGID_PKMNINCAPABLEOFPOWER- BATTLESTRINGS_ID_ADDER] = sText_PkmnIncapableOfPower,
        [STRINGID_GLINTAPPEARSINEYE- BATTLESTRINGS_ID_ADDER] = sText_GlintAppearsInEye,
        [STRINGID_PKMNGETTINGINTOPOSITION- BATTLESTRINGS_ID_ADDER] = sText_PkmnGettingIntoPosition,
        [STRINGID_PKMNBEGANGROWLINGDEEPLY- BATTLESTRINGS_ID_ADDER] = sText_PkmnBeganGrowlingDeeply,
        [STRINGID_PKMNEAGERFORMORE- BATTLESTRINGS_ID_ADDER] = sText_PkmnEagerForMore,
        [STRINGID_DEFEATEDOPPONENTBYREFEREE- BATTLESTRINGS_ID_ADDER] = sText_DefeatedOpponentByReferee,
        [STRINGID_LOSTTOOPPONENTBYREFEREE- BATTLESTRINGS_ID_ADDER] = sText_LostToOpponentByReferee,
        [STRINGID_TIEDOPPONENTBYREFEREE- BATTLESTRINGS_ID_ADDER] = sText_TiedOpponentByReferee,
        [STRINGID_QUESTIONFORFEITMATCH- BATTLESTRINGS_ID_ADDER] = sText_QuestionForfeitMatch,
        [STRINGID_FORFEITEDMATCH- BATTLESTRINGS_ID_ADDER] = sText_ForfeitedMatch,
        [STRINGID_PKMNTRANSFERREDSOMEONESPC- BATTLESTRINGS_ID_ADDER] = gText_PkmnTransferredSomeonesPC,
        [STRINGID_PKMNTRANSFERREDLANETTESPC- BATTLESTRINGS_ID_ADDER] = gText_PkmnTransferredLanettesPC,
        [STRINGID_PKMNBOXSOMEONESPCFULL- BATTLESTRINGS_ID_ADDER] = gText_PkmnTransferredSomeonesPCBoxFull,
        [STRINGID_PKMNBOXLANETTESPCFULL- BATTLESTRINGS_ID_ADDER] = gText_PkmnTransferredLanettesPCBoxFull,
        [STRINGID_TRAINER1WINTEXT- BATTLESTRINGS_ID_ADDER] = sText_Trainer1WinText,
        [STRINGID_TRAINER2WINTEXT- BATTLESTRINGS_ID_ADDER] = sText_Trainer2WinText,
        [STRINGID_ENDUREDSTURDY- BATTLESTRINGS_ID_ADDER] = sText_EnduredViaSturdy,
        [STRINGID_POWERHERB- BATTLESTRINGS_ID_ADDER] = sText_PowerHerbActivation,
        [STRINGID_HURTBYITEM- BATTLESTRINGS_ID_ADDER] = sText_HurtByItem,
        [STRINGID_PSNBYITEM- BATTLESTRINGS_ID_ADDER] = sText_BadlyPoisonedByItem,
        [STRINGID_BRNBYITEM- BATTLESTRINGS_ID_ADDER] = sText_BurnedByItem,
        [STRINGID_DEFABILITYIN- BATTLESTRINGS_ID_ADDER] = sText_TargetAbilityActivates,
        [STRINGID_GRAVITYINTENSIFIED- BATTLESTRINGS_ID_ADDER] = sText_GravityIntensified,
        [STRINGID_TARGETIDENTIFIED- BATTLESTRINGS_ID_ADDER] = sText_TargetIdentified,
        [STRINGID_TARGETWOKEUP- BATTLESTRINGS_ID_ADDER] = sText_TargetWokeUp,
        [STRINGID_PKMNSTOLEANDATEITEM- BATTLESTRINGS_ID_ADDER] = sText_PkmnStoleAndAteItem,
        [STRINGID_TAILWINDBLEW- BATTLESTRINGS_ID_ADDER] = sText_TailWindBlew,
        [STRINGID_PKMNWENTBACK- BATTLESTRINGS_ID_ADDER] = sText_PkmnWentBack,
        [STRINGID_PKMNCANTUSEITEMSANYMORE- BATTLESTRINGS_ID_ADDER] = sText_PkmnCantUseItemsAnymore,
        [STRINGID_PKMNFLUNG- BATTLESTRINGS_ID_ADDER] = sText_PkmnFlung,
        [STRINGID_PKMNPREVENTEDFROMHEALING- BATTLESTRINGS_ID_ADDER] = sText_PkmnPreventedFromHealing,
        [STRINGID_PKMNSWITCHEDATKANDDEF- BATTLESTRINGS_ID_ADDER] = sText_PkmnSwitchedAtkAndDef,
        [STRINGID_PKMNSABILITYSUPPRESSED- BATTLESTRINGS_ID_ADDER] = sText_PkmnsAbilitySuppressed,
        [STRINGID_SHIELDEDFROMCRITICALHITS- BATTLESTRINGS_ID_ADDER] = sText_ShieldedFromCriticalHits,
        [STRINGID_SWITCHEDATKANDSPATK- BATTLESTRINGS_ID_ADDER] = sText_SwitchedAtkAndSpAtk,
        [STRINGID_SWITCHEDDEFANDSPDEF- BATTLESTRINGS_ID_ADDER] = sText_SwitchedDefAndSpDef,
        [STRINGID_PKMNACQUIREDABILITY- BATTLESTRINGS_ID_ADDER] = sText_PkmnAcquiredAbility,
        [STRINGID_POISONSPIKESSCATTERED- BATTLESTRINGS_ID_ADDER] = sText_PoisonSpikesScattered,
        [STRINGID_PKMNSWITCHEDSTATCHANGES- BATTLESTRINGS_ID_ADDER] = sText_PkmnSwitchedStatChanges,
        [STRINGID_PKMNSURROUNDEDWITHVEILOFWATER- BATTLESTRINGS_ID_ADDER] = sText_PkmnSurroundedWithVeilOfWater,
        [STRINGID_PKMNLEVITATEDONELECTROMAGNETISM- BATTLESTRINGS_ID_ADDER] = sText_PkmnLevitatedOnElectromagnetism,
        [STRINGID_PKMNTWISTEDDIMENSIONS- BATTLESTRINGS_ID_ADDER] = sText_PkmnTwistedDimensions,
        [STRINGID_POINTEDSTONESFLOAT- BATTLESTRINGS_ID_ADDER] = sText_PointedStonesFloat,
        [STRINGID_CLOAKEDINMYSTICALMOONLIGHT- BATTLESTRINGS_ID_ADDER] = sText_CloakedInMysticalMoonlight,
        [STRINGID_TRAPPERBYSWIRLINGMAGMA- BATTLESTRINGS_ID_ADDER] = sText_TrappedBySwirlingMagma,
        [STRINGID_VANISHEDINSTANTLY- BATTLESTRINGS_ID_ADDER] = sText_VanishedInstantly,
        [STRINGID_PROTECTEDTEAM- BATTLESTRINGS_ID_ADDER] = sText_ProtectedTeam,
        [STRINGID_SHAREDITSGUARD- BATTLESTRINGS_ID_ADDER] = sText_SharedItsGuard,
        [STRINGID_SHAREDITSPOWER- BATTLESTRINGS_ID_ADDER] = sText_SharedItsPower,
        [STRINGID_SWAPSDEFANDSPDEFOFALLPOKEMON- BATTLESTRINGS_ID_ADDER] = sText_SwapsDefAndSpDefOfAllPkmn,
        [STRINGID_BECAMENIMBLE- BATTLESTRINGS_ID_ADDER] = sText_BecameNimble,
        [STRINGID_HURLEDINTOTHEAIR- BATTLESTRINGS_ID_ADDER] = sText_HurledIntoTheAir,
        [STRINGID_HELDITEMSLOSEEFFECTS- BATTLESTRINGS_ID_ADDER] = sText_HeldItemsLoseEffects,
        [STRINGID_FELLSTRAIGHTDOWN- BATTLESTRINGS_ID_ADDER] = sText_FellStraightDown,
        [STRINGID_TRANSFORMEDINTOWATERTYPE- BATTLESTRINGS_ID_ADDER] = sText_TransformedIntoWaterType,
        [STRINGID_PKMNACQUIREDSIMPLE- BATTLESTRINGS_ID_ADDER] = sText_PkmnAcquiredSimple,
        [STRINGID_EMPTYSTRING5- BATTLESTRINGS_ID_ADDER] = sText_EmptyString4,
        [STRINGID_KINDOFFER- BATTLESTRINGS_ID_ADDER] = sText_KindOffer,
        [STRINGID_RESETSTARGETSSTATLEVELS- BATTLESTRINGS_ID_ADDER] = sText_ResetsTargetsStatLevels,
        [STRINGID_EMPTYSTRING6- BATTLESTRINGS_ID_ADDER] = sText_EmptyString4,
        [STRINGID_ALLYSWITCHPOSITION- BATTLESTRINGS_ID_ADDER] = sText_AllySwitchPosition,
        [STRINGID_RESTORETARGETSHEALTH- BATTLESTRINGS_ID_ADDER] = sText_RestoreTargetsHealth,
        [STRINGID_TOOKPJMNINTOTHESKY- BATTLESTRINGS_ID_ADDER] = sText_TookPkmnIntoTheSky,
        [STRINGID_FREEDFROMSKYDROP- BATTLESTRINGS_ID_ADDER] = sText_FreedFromSkyDrop,
        [STRINGID_POSTPONETARGETMOVE- BATTLESTRINGS_ID_ADDER] = sText_PostponeTargetMove,
        [STRINGID_REFLECTTARGETSTYPE- BATTLESTRINGS_ID_ADDER] = sText_ReflectTargetsType,
        [STRINGID_TRANSFERHELDITEM- BATTLESTRINGS_ID_ADDER] = sText_TransferHeldItem,
        [STRINGID_EMBARGOENDS- BATTLESTRINGS_ID_ADDER] = sText_EmbargoEnds,
        [STRINGID_ELECTROMAGNETISM- BATTLESTRINGS_ID_ADDER] = sText_Electromagnetism,
        [STRINGID_BUFFERENDS- BATTLESTRINGS_ID_ADDER] = sText_BufferEnds,
        [STRINGID_TELEKINESISENDS- BATTLESTRINGS_ID_ADDER] = sText_TelekinesisEnds,
        [STRINGID_TAILWINDENDS- BATTLESTRINGS_ID_ADDER] = sText_TailwindEnds,
        [STRINGID_LUCKYCHANTENDS- BATTLESTRINGS_ID_ADDER] = sText_LuckyChantEnds,
        [STRINGID_TRICKROOMENDS- BATTLESTRINGS_ID_ADDER] = sText_TrickRoomEnds,
        [STRINGID_WONDERROOMENDS- BATTLESTRINGS_ID_ADDER] = sText_WonderRoomEnds,
        [STRINGID_MAGICROOMENDS- BATTLESTRINGS_ID_ADDER] = sText_MagicRoomEnds,
        [STRINGID_MUDSPORTENDS- BATTLESTRINGS_ID_ADDER] = sText_MudSportEnds,
        [STRINGID_WATERSPORTENDS- BATTLESTRINGS_ID_ADDER] = sText_WaterSportEnds,
        [STRINGID_GRAVITYENDS- BATTLESTRINGS_ID_ADDER] = sText_GravityEnds,
        [STRINGID_AQUARINGHEAL- BATTLESTRINGS_ID_ADDER] = sText_AquaRingHeal,
        [STRINGID_AURORAVEILENDS- BATTLESTRINGS_ID_ADDER] = sText_AuroraVeilEnds,
        [STRINGID_ELECTRICTERRAINENDS- BATTLESTRINGS_ID_ADDER] = sText_ElectricTerrainEnds,
        [STRINGID_MISTYTERRAINENDS- BATTLESTRINGS_ID_ADDER] = sText_MistyTerrainEnds,
        [STRINGID_PSYCHICTERRAINENDS- BATTLESTRINGS_ID_ADDER] = sText_PsychicTerrainEnds,
        [STRINGID_GRASSYTERRAINENDS- BATTLESTRINGS_ID_ADDER] = sText_GrassyTerrainEnds,
        [STRINGID_TARGETABILITYSTATRAISE- BATTLESTRINGS_ID_ADDER] = sText_TargetAbilityRaisedStat,
        [STRINGID_TARGETSSTATWASMAXEDOUT- BATTLESTRINGS_ID_ADDER] = sText_TargetsStatWasMaxedOut,
        [STRINGID_ATTACKERABILITYSTATRAISE- BATTLESTRINGS_ID_ADDER] = sText_AttackerAbilityRaisedStat,
        [STRINGID_POISONHEALHPUP- BATTLESTRINGS_ID_ADDER] = sText_PoisonHealHpUp,
        [STRINGID_BADDREAMSDMG- BATTLESTRINGS_ID_ADDER] = sText_BadDreamsDmg,
        [STRINGID_MOLDBREAKERENTERS- BATTLESTRINGS_ID_ADDER] = sText_MoldBreakerEnters,
        [STRINGID_TERAVOLTENTERS- BATTLESTRINGS_ID_ADDER] = sText_TeravoltEnters,
        [STRINGID_TURBOBLAZEENTERS- BATTLESTRINGS_ID_ADDER] = sText_TurboblazeEnters,
        [STRINGID_SLOWSTARTENTERS- BATTLESTRINGS_ID_ADDER] = sText_SlowStartEnters,
        [STRINGID_SLOWSTARTEND- BATTLESTRINGS_ID_ADDER] = sText_SlowStartEnd,
        [STRINGID_SOLARPOWERHPDROP- BATTLESTRINGS_ID_ADDER] = sText_SolarPowerHpDrop,
        [STRINGID_AFTERMATHDMG- BATTLESTRINGS_ID_ADDER] = sText_AftermathDmg,
        [STRINGID_ANTICIPATIONACTIVATES- BATTLESTRINGS_ID_ADDER] = sText_AnticipationActivates,
        [STRINGID_FOREWARNACTIVATES- BATTLESTRINGS_ID_ADDER] = sText_ForewarnActivates,
        [STRINGID_ICEBODYHPGAIN- BATTLESTRINGS_ID_ADDER] = sText_IceBodyHpGain,
        [STRINGID_SNOWWARNINGHAIL- BATTLESTRINGS_ID_ADDER] = sText_SnowWarningHail,
        [STRINGID_FRISKACTIVATES- BATTLESTRINGS_ID_ADDER] = sText_FriskActivates,
        [STRINGID_UNNERVEENTERS- BATTLESTRINGS_ID_ADDER] = sText_UnnerveEnters,
        [STRINGID_HARVESTBERRY- BATTLESTRINGS_ID_ADDER] = sText_HarvestBerry,
        [STRINGID_LASTABILITYRAISEDSTAT- BATTLESTRINGS_ID_ADDER] = sText_LastAbilityRaisedBuff1,
        [STRINGID_MAGICBOUNCEACTIVATES- BATTLESTRINGS_ID_ADDER] = sText_MagicBounceActivates,
        [STRINGID_PROTEANTYPECHANGE- BATTLESTRINGS_ID_ADDER] = sText_ProteanTypeChange,
        [STRINGID_SYMBIOSISITEMPASS- BATTLESTRINGS_ID_ADDER] = sText_SymbiosisItemPass,
        [STRINGID_STEALTHROCKDMG- BATTLESTRINGS_ID_ADDER] = sText_StealthRockDmg,
        [STRINGID_TOXICSPIKESABSORBED- BATTLESTRINGS_ID_ADDER] = sText_ToxicSpikesAbsorbed,
        [STRINGID_TOXICSPIKESPOISONED- BATTLESTRINGS_ID_ADDER] = sText_ToxicSpikesPoisoned,
        [STRINGID_STICKYWEBSWITCHIN- BATTLESTRINGS_ID_ADDER] = sText_StickyWebSwitchIn,
        [STRINGID_HEALINGWISHCAMETRUE- BATTLESTRINGS_ID_ADDER] = sText_HealingWishCameTrue,
        [STRINGID_HEALINGWISHHEALED- BATTLESTRINGS_ID_ADDER] = sText_HealingWishHealed,
        [STRINGID_LUNARDANCECAMETRUE- BATTLESTRINGS_ID_ADDER] = sText_LunarDanceCameTrue,
        [STRINGID_CUSEDBODYDISABLED- BATTLESTRINGS_ID_ADDER] = sText_CursedBodyDisabled,
        [STRINGID_ATTACKERACQUIREDABILITY- BATTLESTRINGS_ID_ADDER] = sText_AttackerAquiredAbility,
        [STRINGID_TARGETABILITYSTATLOWER- BATTLESTRINGS_ID_ADDER] = sText_TargetAbilityLoweredStat,
        [STRINGID_TARGETSTATWONTGOHIGHER- BATTLESTRINGS_ID_ADDER] = sText_TargetStatWontGoHigher,
        [STRINGID_PKMNMOVEBOUNCEDABILITY- BATTLESTRINGS_ID_ADDER] = sText_PkmnMoveBouncedViaAbility,
        [STRINGID_IMPOSTERTRANSFORM- BATTLESTRINGS_ID_ADDER] = sText_ImposterTransform,
        [STRINGID_ASSAULTVESTDOESNTALLOW- BATTLESTRINGS_ID_ADDER] = sText_AssaultVestDoesntAllow,
        [STRINGID_GRAVITYPREVENTSUSAGE- BATTLESTRINGS_ID_ADDER] = sText_GravityPreventsUsage,
        [STRINGID_HEALBLOCKPREVENTSUSAGE- BATTLESTRINGS_ID_ADDER] = sText_HealBlockPreventsUsage,
        [STRINGID_NOTDONEYET- BATTLESTRINGS_ID_ADDER] = sText_NotDoneYet,
        [STRINGID_STICKYWEBUSED- BATTLESTRINGS_ID_ADDER] = sText_StickyWebUsed,
        [STRINGID_QUASHSUCCESS- BATTLESTRINGS_ID_ADDER] = sText_QuashSuccess,
        [STRINGID_PKMNBLEWAWAYTOXICSPIKES- BATTLESTRINGS_ID_ADDER] = sText_PkmnBlewAwayToxicSpikes,
        [STRINGID_PKMNBLEWAWAYSTICKYWEB- BATTLESTRINGS_ID_ADDER] = sText_PkmnBlewAwayStickyWeb,
        [STRINGID_PKMNBLEWAWAYSTEALTHROCK- BATTLESTRINGS_ID_ADDER] = sText_PkmnBlewAwayStealthRock,
        [STRINGID_IONDELUGEON- BATTLESTRINGS_ID_ADDER] = sText_IonDelugeOn,
        [STRINGID_TOPSYTURVYSWITCHEDSTATS- BATTLESTRINGS_ID_ADDER] = sText_TopsyTurvySwitchedStats,
        [STRINGID_TERRAINBECOMESMISTY- BATTLESTRINGS_ID_ADDER] = sText_TerrainBecomesMisty,
        [STRINGID_TERRAINBECOMESGRASSY- BATTLESTRINGS_ID_ADDER] = sText_TerrainBecomesGrassy,
        [STRINGID_TERRAINBECOMESELECTRIC- BATTLESTRINGS_ID_ADDER] = sText_TerrainBecomesElectric,
        [STRINGID_TERRAINBECOMESPSYCHIC- BATTLESTRINGS_ID_ADDER] = sText_TerrainBecomesPsychic,
        [STRINGID_TARGETELECTRIFIED- BATTLESTRINGS_ID_ADDER] = sText_TargetElectrified,
        [STRINGID_MEGAEVOREACTING- BATTLESTRINGS_ID_ADDER] = sText_MegaEvoReacting,
        [STRINGID_FERVENTWISHREACHED- BATTLESTRINGS_ID_ADDER] = sText_FerventWishReached,
        [STRINGID_MEGAEVOEVOLVED- BATTLESTRINGS_ID_ADDER] = sText_MegaEvoEvolved,
        [STRINGID_DRASTICALLY- BATTLESTRINGS_ID_ADDER] = sText_drastically,
        [STRINGID_SEVERELY- BATTLESTRINGS_ID_ADDER] = sText_severely,
        [STRINGID_INFESTATION- BATTLESTRINGS_ID_ADDER] = sText_Infestation,
        [STRINGID_NOEFFECTONTARGET- BATTLESTRINGS_ID_ADDER] = sText_NoEffectOnTarget,
        [STRINGID_BURSTINGFLAMESHIT- BATTLESTRINGS_ID_ADDER] = sText_BurstingFlames,
        [STRINGID_BESTOWITEMGIVING- BATTLESTRINGS_ID_ADDER] = sText_BestowItemGiving,
        [STRINGID_THIRDTYPEADDED- BATTLESTRINGS_ID_ADDER] = sText_ThirdTypeAdded,
        [STRINGID_FELLFORFEINT- BATTLESTRINGS_ID_ADDER] = sText_FellForFeint,
        [STRINGID_POKEMONCANNOTUSEMOVE- BATTLESTRINGS_ID_ADDER] = sText_PokemonCannotUseMove,
        [STRINGID_COVEREDINPOWDER- BATTLESTRINGS_ID_ADDER] = sText_CoveredInPowder,
        [STRINGID_POWDEREXPLODES- BATTLESTRINGS_ID_ADDER] = sText_PowderExplodes,
        [STRINGID_GRAVITYGROUNDING- BATTLESTRINGS_ID_ADDER] = sText_GravityGrounding,
        [STRINGID_MISTYTERRAINPREVENTS- BATTLESTRINGS_ID_ADDER] = sText_MistyTerrainPreventsStatus,
        [STRINGID_GRASSYTERRAINHEALS- BATTLESTRINGS_ID_ADDER] = sText_GrassyTerrainHeals,
        [STRINGID_ELECTRICTERRAINPREVENTS- BATTLESTRINGS_ID_ADDER] = sText_ElectricTerrainPreventsSleep,
        [STRINGID_PSYCHICTERRAINPREVENTS- BATTLESTRINGS_ID_ADDER] = sText_PsychicTerrainPreventsPriority,
        [STRINGID_AURAFLAREDTOLIFE- BATTLESTRINGS_ID_ADDER] = sText_AuraFlaredToLife,
        [STRINGID_AIRLOCKACTIVATES- BATTLESTRINGS_ID_ADDER] = sText_AirLockActivates,
        [STRINGID_PRESSUREENTERS- BATTLESTRINGS_ID_ADDER] = sText_PressureActivates,
        [STRINGID_DARKAURAENTERS- BATTLESTRINGS_ID_ADDER] = sText_DarkAuraActivates,
        [STRINGID_FAIRYAURAENTERS- BATTLESTRINGS_ID_ADDER] = sText_FairyAuraActivates,
        [STRINGID_AURABREAKENTERS- BATTLESTRINGS_ID_ADDER] = sText_AuraBreakActivates,
        [STRINGID_COMATOSEENTERS- BATTLESTRINGS_ID_ADDER] = sText_ComatoseActivates,
        [STRINGID_SCREENCLEANERENTERS- BATTLESTRINGS_ID_ADDER] = sText_ScreenCleanerActivates,
};
