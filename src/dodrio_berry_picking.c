...
// Clean up macros
#undef NUM_STATUS_SQUARES
#undef NUM_BERRY_COLUMNS
#undef GFXTAG_DODRIO
#undef GFXTAG_STATUS
#undef GFXTAG_BERRIES
#undef GFXTAG_CLOUD
#undef GFXTAG_COUNTDOWN
#undef PALTAG_DODRIO_NORMAL
#undef PALTAG_DODRIO_SHINY
#undef PALTAG_STATUS
#undef PALTAG_BERRIES
#undef PALTAG_CLOUD
#undef PALTAG_COUNTDOWN
#undef NUM_CLOUDS
#undef PLAYER_NONE